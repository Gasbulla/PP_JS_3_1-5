package com.example.pp_js_3_15.Connection;

import com.example.pp_js_3_15.Entity.User;
...
public class Connection {
    ...
    @Autowired
    public void Communication(RestTemplate restTemplate,
                              HttpHeaders headers) {
        this.restTemplate = restTemplate;
        this.headers = headers;
        this.headers.set("Cookie",
                String.join(";", Objects.requireNonNull(restTemplate
                        .headForHeaders(URL).get("Set-Cookie"))));
    }
    ...
    private ResponseEntity<String> updateUser() {
        User user = new User(3L, "Thomas",
                "Shelby", (byte) 5);
        HttpEntity<User> entity = new HttpEntity<>(user, headers);
        return restTemplate.exchange(URL, HttpMethod.PUT,
                entity, String.class, 3);
    }
    ...
    private ResponseEntity<String> deleteUser() {
        ...
        return restTemplate.exchange(URL + "/{id}", HttpMethod.DELETE,
